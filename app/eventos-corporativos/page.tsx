          ...
          <div className="max-w-4xl">
            <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter mb-6 text-primary leading-[0.9] uppercase">
                Transforme seu <br/>
                <span className="text-foreground opacity-90">evento corporativo</span>
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-8 font-light leading-relaxed tracking-wide uppercase">
                Experiências inesquecíveis com a qualidade cinematográfica que sua marca merece.
              </p>
              <Link href="#portfolio">
                <Button onClick={handleRdStationPopup} className="rounded-none px-10 py-7 text-lg bg-primary text-white hover:bg-primary/90 transition-all font-heading uppercase tracking-widest">
                  Ver Portfólio
      ...
      <section className="py-32 px-6 md:px-12 lg:px-24 bg-transparent">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="text-xs font-heading font-bold uppercase tracking-[0.3em] text-primary mb-6">Serviços</h2>
              <h3 className="font-heading text-4xl md:text-5xl font-bold mb-6 uppercase leading-none">Cobertura Completa</h3>
              <p className="text-muted-foreground text-lg font-light leading-relaxed">
                Desde convenções de vendas até lançamentos de produtos, garantimos qualidade técnica e criativa.
              </p>
            </motion.div>
              ...
              {[
                ...
                >
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-xl font-heading font-bold uppercase tracking-wide text-foreground">{service.title}</h3>
                  </div>
