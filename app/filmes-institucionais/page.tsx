    ...
    <div className="min-h-screen bg-black text-white">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <h1 className="text-3xl md:text-5xl lg:text-5xl font-light mb-6 leading-tight">
                <span className="text-primary font-semibold">Especialistas</span> em contar histórias com excelência
              </h1>
      ...
      <section className="py-20 bg-black border-t border-white/10">
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-light mb-6">Versões disponíveis</h2>
          </motion.div>
            ...
            {[
              ...
              >
                <div className="flex items-center mb-6">
                  <span className="bg-primary/20 text-primary w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold mr-4">
                    {version.number}
                  </span>
                  <h3 className="text-xl font-semibold">{version.title}</h3>
                </div>
                <p className="text-gray-300 mb-4 leading-relaxed">{version.description}</p>
                <p className="text-primary font-semibold">Duração: {version.duration}</p>
              </motion.div>
            ))}
          </div>
          ...
          >
            <h3 className="text-2xl md:text-3xl font-light mb-8">Opções de formatos</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
              <div className="modern-card p-8 text-center">
                <div className="bg-gray-800 w-full h-24 rounded-lg mb-4 flex items-center justify-center">
                  <span className="text-primary font-bold text-lg">16:9</span>
                </div>
                <h4 className="font-semibold mb-2">Wide (16:9)</h4>
                <p className="text-gray-400 text-sm">
                  Ideal para uso em sites, comerciais, apresentações e plataformas como o YouTube.
                </p>
              </div>
              <div className="modern-card p-8 text-center">
                <div className="bg-gray-800 w-16 h-24 rounded-lg mb-4 mx-auto flex items-center justify-center">
                  <span className="text-primary font-bold text-lg">9:16</span>
                </div>
                <h4 className="font-semibold mb-2">Vertical (9:16)</h4>
                <p className="text-gray-400 text-sm">Ideal para Reels, Shorts, Stories, TikTok e status.</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section id="portfolio" className="py-20 bg-black border-t border-white/10">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-light mb-6">Portfólio</h2>
            <p className="text-xl text-gray-400 font-light">Confira alguns dos nossos trabalhos institucionais</p>
          </motion.div>
